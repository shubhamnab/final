...
var quizMaster = (function () {
	...
	function displayQuiz(successCb) {
		...
		displayDom.off("click", ".quizMasterPrevious", previousHandler);
		//Then restore it
		displayDom.on("click", ".quizMasterPrevious", previousHandler);
	...
	function previousButton() {
		return "<a href='' class='quizMasterPrevious' data-role='button'>Previous</a>";	
	}
